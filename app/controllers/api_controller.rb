class ApiController < ApplicationController
    ...
    def create
        ...
        #
        # Find or create the owner.  There should always be one since
        # the ower is the entity that pays for the the
        # registration. The owner may already be in the database from
        ...
        if group_registration
            ...
            group.owner = owner
            group.save
            group.handle = owner.wp_last_name + "#" + group.id.to_s
            group.save!
        end
