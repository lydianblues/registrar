...
CREATE TABLE "students" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "wp_first_name" varchar, "wp_last_name" varchar, "wp_email" varchar, "wp_id" integer, "occupation" varchar, "organization" varchar, "wp_login" varchar, "wp_display_name" varchar, "email_list" boolean, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
